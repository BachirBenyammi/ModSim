...
procedure TfrmDE.InitialiseTable;
var
  i:integer;
begin
  with sgTable do
...
procedure TfrmDE.btnSimuleClick(Sender: TObject);
var
  u, cumul: real;
  i,j: integer;
begin
...
procedure TfrmDE.FormCreate(Sender: TObject);
begin
  Randomize;
  InitialiseTable;
end;

procedure TfrmDE.btnArreterClick(Sender: TObject);
begin
  Stop := true;
end;

procedure TfrmDE.btnInitialiseClick(Sender: TObject);
begin
  InitialiseTable;
  Stop := False;
end;

procedure TfrmDE.Edit_CompteurChange(Sender: TObject);
begin
  Compteur := StrToInt(Edit_Compteur.Text);
end;

procedure TfrmDE.Edit_PrecisionChange(Sender: TObject);
begin
 Precision := StrToFloat(Edit_Precision.Text);
end;
