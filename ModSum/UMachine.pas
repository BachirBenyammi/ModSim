...
// Initialisation
procedure TFrmMachine.btnInitialiseClick(Sender: TObject);
begin
  Etat := Attente;
  lbHistorique.Clear;
...
begin
  FrmMachine.lbHistorique.Items.Add(Composant_Etat[Nbr]);
end;

// Changement d'état
procedure TFrmMachine.btnEauClick(Sender: TObject);
var
  Nbr:byte;
begin
