...
procedure TfrmMontre.Proc_Aff_Heure;
begin
...
procedure TfrmMontre.Proc_Aff_Minute;
begin
...
procedure TfrmMontre.Proc_Aff_Mois;
begin
...
procedure TfrmMontre.Proc_Aff_Jour;
begin
...
procedure TfrmMontre.Proc_Aff_Annee;
begin
...
procedure TfrmMontre.Proc_Affichage;
begin
  Etat := Affichage;
  Panel_left.Caption := IntToStr(Heure);
  Panel_Right.Caption := IntToStr(Minute);
...
procedure TfrmMontre.Proc_Reglage;
begin
  Etat := Reglage;
  Panel_left.Caption := IntToStr(Heure);
  Panel_Right.Caption := IntToStr(Minute);
...
procedure TfrmMontre.Proc_Aff_Date;
begin
  Etat := Affichage_Date;
  Panel_left.Caption := IntToStr(Mois);
  Panel_Right.Caption := IntToStr(Jour);
...
procedure TfrmMontre.Proc_Limiere;
begin
...
procedure TfrmMontre.Transistion(Symbole : TSymbole; Etat : TEtat);
begin
  case Symbole of
    Bouton_A:
      case Etat of
...
procedure TfrmMontre.SpeedButton1Click(Sender: TObject);
begin
  Transistion(Bouton_A, Etat);
end;

procedure TfrmMontre.SpeedButton2Click(Sender: TObject);
begin
  Transistion(Bouton_B, Etat);
end;

procedure TfrmMontre.SpeedButton3Click(Sender: TObject);
begin
  Transistion(Bouton_C, Etat);
end;

procedure TfrmMontre.FormCreate(Sender: TObject);
begin
  Heure := HourOf(Now);
  Minute := MinuteOf(Now);
  Jour := DayOf(Now);
...
procedure TfrmMontre.Timer1Timer(Sender: TObject);
begin
  case Etat of
...
procedure TfrmMontre.SpeedButton4Click(Sender: TObject);
begin
  Proc_Limiere;
end;
