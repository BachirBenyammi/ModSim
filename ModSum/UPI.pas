...
procedure TfrmPI.btnSimuleClick(Sender: TObject);
begin
...
procedure TfrmPI.btnStopClick(Sender: TObject);
begin
  Stop := true;
end;

procedure TfrmPI.Edit_CompteurChange(Sender: TObject);
begin
  Compteur :=  StrToInt(Edit_Compteur.Text);
end;

procedure TfrmPI.btnInitialiseClick(Sender: TObject);
begin
  Stop := true;
  Initialise;
end;

procedure TfrmPI.FormPaint(Sender: TObject);
begin
  Initialise
end;
